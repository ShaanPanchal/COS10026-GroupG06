...
<section class="hero-section">
    <div class="hero-content">
        ...
        <div class="home-action-buttons">
            <a href="apply.php" class="primary-button btn-apply">💼 Apply for a Job</a>
            <?php if (!isset($_SESSION['eoi_number'])): ?>
                <a href="login.php" class="secondary-button btn-login">🔐 Check Application Status</a>
            <?php else: ?>
                <a href="status.php" class="secondary-button btn-status">📄 View My Application</a>
                <a href="logout.php" class="secondary-button btn-logout">🚪 Log Out</a>
            <?php endif; ?>
        </div>
    </div>
</section>
